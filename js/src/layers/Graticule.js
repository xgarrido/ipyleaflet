...
export class LeafletGraticuleModel extends layer.LeafletLayerModel {
  defaults() {
    return {
      ...super.defaults(),
...
export class LeafletGraticuleView extends layer.LeafletLayerView {
  create_obj() {
      this.obj = L.latlngGraticule(this.get_options());
      window.grat = this.obj;
  }
}
