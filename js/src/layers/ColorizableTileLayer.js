...
export class LeafletColorizableTileLayerModel extends tilelayer.LeafletTileLayerModel {
    defaults() {
        return {
            ...super.defaults(),
...
export class LeafletColorizableTileLayerView extends tilelayer.LeafletTileLayerView {
    create_obj() {
        this.obj = L.tileLayer.colorizable(this.model.get('url'), this.get_options());
    }
    model_events() {
        super.model_events();
        this.listenTo(
